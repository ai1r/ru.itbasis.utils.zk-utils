...
@Aspect
public class LoggerAbstractDialog {
		private transient static final Logger LOG = LoggerFactory.getLogger(LoggerAbstractDialog.class.getName());

		@Pointcut("execution(* *.loadFieldData()) && this(ru.itbasis.utils.zk.ui.form.AbstractDialog)")
